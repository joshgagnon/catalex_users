...
<body>
	...
	<div class="container">
		<div class="row">
			<div class="col-xs-12">
				<h2>CataLex is currently unavailable due to maintenance</h2>
				<p>Sorry for the inconvenience. Please try again in just a few moments...</p>
			</div>
		</div>
	</div>
	<footer class="footer">
		<div class="container text-center">
			...
			<p class="links"><a href="/privacypolicy">Privacy Policy</a><a href="/termsofuse">Terms of Use</a></p>
