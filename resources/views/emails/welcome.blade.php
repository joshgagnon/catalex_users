						...
						<table class="twelve columns">
							<tr>
								<td>
									...
									<p>Hi {{ $name }},</p>
									<p>Thanks for signing up with CataLex &mdash; the legal catalyst. You can now save and load sessions with <a href="{{ route('browser-login') }}">Law Browser</a>.  You can also try out our new company administration service called <a href="{{ route('good-companies-login') }}">Good Companies</a>.  It costs just $12 annually or $1.50 monthly, per company.</p>
