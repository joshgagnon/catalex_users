...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->bind('App\\Services\\InviteBroker', function () {
            return new \App\Services\InviteBroker($this->app->make('Illuminate\\Auth\\Passwords\\TokenRepositoryInterface'), $this->app->make('Illuminate\\Contracts\\Auth\\UserProvider'), $this->app->make('Illuminate\\Contracts\\Mail\\Mailer'), 'emails.invite');
        });
        $this->app->bind('App\\Services\\ResetBroker', function () {
            return new \App\Services\ResetBroker($this->app->make('Illuminate\\Auth\\Passwords\\TokenRepositoryInterface'), $this->app->make('Illuminate\\Contracts\\Auth\\UserProvider'), $this->app->make('Illuminate\\Contracts\\Mail\\Mailer'), 'emails.reset-password');
        });
    }
}
}
